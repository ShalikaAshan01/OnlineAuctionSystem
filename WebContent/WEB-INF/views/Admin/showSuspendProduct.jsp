...
<title>eBid:Admin-Show Suspend Products</title>
...
<div id = "outer">
	...
	<div id="main">
<h3 style="color: navy;" align="center"><B>Product-Show Suspend Products</B></h3>
...
<th>Add</th>
						...
						<% ProductService prod = new ProductServiceImpl();
							...
							ArrayList<ProductModel> pro = prod.showProducts("suspend"); 
