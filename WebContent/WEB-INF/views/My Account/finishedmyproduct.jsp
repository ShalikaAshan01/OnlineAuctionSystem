...
<%
    ...
    if(null ==session.getAttribute("loggedinUser")){
    	session.setAttribute("from", "finishedmyproduct");
...
<html lang="en">
<head>
	<title>eBid:Show My Products-Finished Product</title>
...
<div class="dropdown">
  <div class="dropdown-content">
    <a href="myproduct">All Products</a>
    <a href="ongoingmyauction">Ongoing Auction</a>
    <a href="finishedmyproduct">Finished</a>
  </div>
</div>
<table id="products">
...
<th>Send to Customer</th>
						...
						<% ProductService prod = new ProductServiceImpl();
							...
							ArrayList<ProductModel> pro = prod.getAuctionEndProducts(person.getCid()); 
							if(pro.size()==0)
							{
