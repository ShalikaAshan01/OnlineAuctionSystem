...
<%
    ...
    if(null ==session.getAttribute("loggedinUser")){
    	session.setAttribute("from", "soldProduct");
...
<html lang="en">
<head>
	<title>eBid:Show My Products-Sold Products</title>
...
<th>Send to Customer</th>
						...
						<% ProductService prod = new ProductServiceImpl();
							...
							ArrayList<ProductModel> pro = prod.soldProductBySellerID(person.getCid()); 
							if(pro.size()==0)
							{
