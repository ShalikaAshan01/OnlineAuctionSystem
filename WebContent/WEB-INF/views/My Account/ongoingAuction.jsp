...
<%
    ...
    if(null ==session.getAttribute("loggedinUser")){
    	session.setAttribute("from", "ongoingmyauction");
...
<html lang="en">
<head>
	<title>eBid:Show My Products-On Auction</title>
...
<th>Send to Customer</th>
						...
						<% ProductService prod = new ProductServiceImpl();
							...
							ArrayList<ProductModel> pro = prod.OngoingAuctionEndProducts(person.getCid()); 
							if(pro.size()==0)
							{
